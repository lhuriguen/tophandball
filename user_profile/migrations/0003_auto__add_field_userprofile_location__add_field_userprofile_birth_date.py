...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('user_profile', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.birth_date'
        db.add_column('user_profile', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.gender'
        db.add_column('user_profile', 'gender',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('user_profile', 'location')

        # Deleting field 'UserProfile.birth_date'
        db.delete_column('user_profile', 'birth_date')
