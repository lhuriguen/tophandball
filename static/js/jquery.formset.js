...
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            childElementSelector = 'input,select,textarea,label,div,th',
            $$ = $(this),
        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                var template_html = $(options.formTemplate).html();
                template = (options.formTemplate instanceof $) ? options.formTemplate : $($.parseHTML(template_html));
    ...
    $.fn.formset.defaults = {
        ...
        addText: '<i class="fa fa-plus"></i> Add another',          // Text for the add link
        deleteText: '<i class="fa fa-trash-o"></i> Remove',            // Text for the delete link
