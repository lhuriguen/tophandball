...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field competitions on 'Category'
        m2m_table_name = db.shorten_name(u'data_category_competitions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm[u'data.category'], null=False)),
            ('competition', models.ForeignKey(orm[u'data.competition'], null=False))
        ))
        db.create_unique(m2m_table_name, ['category_id', 'competition_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field competitions on 'Category'
        db.delete_table(db.shorten_name(u'data_category_competitions'))
    ...
    models = {
        ...
        u'data.category': {
            ...
            'competitions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['data.Competition']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        u'data.match': {
            ...
            'delegates': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['data.Delegate']", 'symmetrical': 'False', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data.Group']"}),
            ...
            'referees': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['data.Referee']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        u'data.matchteamstats': {
            ...
            'score_pt': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
