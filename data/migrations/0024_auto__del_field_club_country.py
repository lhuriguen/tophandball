...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Club.country'
        db.delete_column(u'data_club', 'country')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Club.country'
        raise RuntimeError("Cannot reverse this migration. 'Club.country' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Club.country'
        db.add_column(u'data_club', 'country',
