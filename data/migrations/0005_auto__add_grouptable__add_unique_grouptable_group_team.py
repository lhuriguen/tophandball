...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_grouptable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Group'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Club'])),
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'data', ['GroupTable'])

        # Adding unique constraint on 'GroupTable', fields ['group', 'team']
        db.create_unique(u'data_grouptable', ['group_id', 'team_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'GroupTable', fields ['group', 'team']
        db.delete_unique(u'data_grouptable', ['group_id', 'team_id'])

        # Deleting model 'GroupTable'
        db.delete_table(u'data_grouptable')
