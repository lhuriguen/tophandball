...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coach.birth_date'
        db.add_column(u'data_coach', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coach.birth_place'
        db.add_column(u'data_coach', 'birth_place',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coach.birth_date'
        db.delete_column(u'data_coach', 'birth_date')

        # Deleting field 'Coach.birth_place'
        db.delete_column(u'data_coach', 'birth_place')
