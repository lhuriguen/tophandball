...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'Club.country_iso'
        db.rename_column(u'data_club', 'country_iso', 'country')

    def backwards(self, orm):
        # Rename field 'Club.country'
        db.rename_column(u'data_club', 'country', 'country_iso')
