...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.refereeA'
        db.add_column(u'data_match', 'refereeA',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Match.refereeB'
        db.add_column(u'data_match', 'refereeB',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.refereeA'
        db.delete_column(u'data_match', 'refereeA')

        # Deleting field 'Match.refereeB'
        db.delete_column(u'data_match', 'refereeB')
