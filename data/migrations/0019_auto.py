...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field fans on 'Player'
        m2m_table_name = db.shorten_name(u'data_player_fans')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('player', models.ForeignKey(orm[u'data.player'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['player_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field fans on 'Player'
        db.delete_table(db.shorten_name(u'data_player_fans'))
