...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.country_iso'
        db.add_column(u'data_player', 'country_iso',
                      self.gf('django_countries.fields.CountryField')(default='', max_length=2),
                      keep_default=False)

        # Adding field 'Coach.country_iso'
        db.add_column(u'data_coach', 'country_iso',
                      self.gf('django_countries.fields.CountryField')(default='', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.country_iso'
        db.delete_column(u'data_player', 'country_iso')

        # Deleting field 'Coach.country_iso'
        db.delete_column(u'data_coach', 'country_iso')
