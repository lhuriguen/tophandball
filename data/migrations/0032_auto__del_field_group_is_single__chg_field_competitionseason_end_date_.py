...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Group.is_single'
        db.delete_column(u'data_group', 'is_single')


        # Changing field 'CompetitionSeason.end_date'
        db.alter_column(u'data_competitionseason', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CompetitionSeason.start_date'
        db.alter_column(u'data_competitionseason', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))
        # Deleting field 'Match.placeholder'
        db.delete_column(u'data_match', 'placeholder')

        # Adding field 'Stage.type'
        db.add_column(u'data_stage', 'type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)

        # Deleting field 'GroupTable.point_penalty'
        db.delete_column(u'data_grouptable', 'point_penalty')

        # Adding field 'GroupTable.start_points'
        db.add_column(u'data_grouptable', 'start_points',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Group.is_single'
        db.add_column(u'data_group', 'is_single',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CompetitionSeason.end_date'
        db.alter_column(u'data_competitionseason', 'end_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'CompetitionSeason.start_date'
        db.alter_column(u'data_competitionseason', 'start_date', self.gf('django.db.models.fields.DateField')(default=None))
        # Adding field 'Match.placeholder'
        db.add_column(u'data_match', 'placeholder',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Deleting field 'Stage.type'
        db.delete_column(u'data_stage', 'type')

        # Adding field 'GroupTable.point_penalty'
        db.add_column(u'data_grouptable', 'point_penalty',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'GroupTable.start_points'
        db.delete_column(u'data_grouptable', 'start_points')
    ...
    models = {
        ...
        u'data.grouptable': {
            ...
            'start_points': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
