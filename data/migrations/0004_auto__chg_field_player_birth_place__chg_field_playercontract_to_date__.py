...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.birth_place'
        db.alter_column(u'data_player', 'birth_place', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'PlayerContract.to_date'
        db.alter_column(u'data_playercontract', 'to_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Match.time'
        db.alter_column(u'data_match', 'time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Match.date'
        db.alter_column(u'data_match', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Player.birth_place'
        db.alter_column(u'data_player', 'birth_place', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'PlayerContract.to_date'
        db.alter_column(u'data_playercontract', 'to_date', self.gf('django.db.models.fields.DateField')(default=''))

        # Changing field 'Match.time'
        db.alter_column(u'data_match', 'time', self.gf('django.db.models.fields.TimeField')(default=''))

        # Changing field 'Match.date'
        db.alter_column(u'data_match', 'date', self.gf('django.db.models.fields.DateField')(default=''))
