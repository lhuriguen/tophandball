...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchPlayerStats.match'
        db.add_column(u'data_matchplayerstats', 'match',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['data.Match']),
                      keep_default=False)

        # Adding field 'MatchPlayerStats.club'
        db.add_column(u'data_matchplayerstats', 'club',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['data.Club']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchPlayerStats.match'
        db.delete_column(u'data_matchplayerstats', 'match_id')

        # Deleting field 'MatchPlayerStats.club'
        db.delete_column(u'data_matchplayerstats', 'club_id')
