...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchTeamStats.score_pt'
        db.add_column(u'data_matchteamstats', 'score_pt',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchTeamStats.score_pt'
        db.delete_column(u'data_matchteamstats', 'score_pt')
