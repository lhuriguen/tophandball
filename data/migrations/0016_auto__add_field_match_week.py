...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'data_group_matches')
        ...
        db.create_unique(m2m_table_name, ['group_id', 'match_id'])

        # Adding field 'Match.week'
        db.add_column(u'data_match', 'week',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'data_group_matches'))

        # Deleting field 'Match.week'
        db.delete_column(u'data_match', 'week')
    ...
    models = {
        ...
        u'data.group': {
            ...
            'matches': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['data.Match']", 'symmetrical': 'False'}),
