...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coach.photo'
        db.add_column(u'data_coach', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Player.photo'
        db.add_column(u'data_player', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Competition.level'
        db.add_column(u'data_competition', 'level',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Competition.logo'
        db.add_column(u'data_competition', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Club.logo'
        db.add_column(u'data_club', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coach.photo'
        db.delete_column(u'data_coach', 'photo')

        # Deleting field 'Player.photo'
        db.delete_column(u'data_player', 'photo')

        # Deleting field 'Competition.level'
        db.delete_column(u'data_competition', 'level')

        # Deleting field 'Competition.logo'
        db.delete_column(u'data_competition', 'logo')

        # Deleting field 'Club.logo'
        db.delete_column(u'data_club', 'logo')
