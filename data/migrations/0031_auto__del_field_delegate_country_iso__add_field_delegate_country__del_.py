...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'data_delegate', 'country_iso', 'country')
        db.rename_column(u'data_referee', 'country_iso', 'country')

    def backwards(self, orm):

        db.rename_column(u'data_delegate', 'country', 'country_iso')
        db.rename_column(u'data_referee', 'country', 'country_iso')
