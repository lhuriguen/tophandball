...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Player.retirement_date'
        db.add_column(u'data_player', 'retirement_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Club.initials'
        db.add_column(u'data_club', 'initials',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True),
                      keep_default=False)


        # Changing field 'Club.short_name'
        db.alter_column(u'data_club', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):
        # Deleting field 'Coach.role'
        db.delete_column(u'data_coach', 'role')

        # Deleting field 'Player.retirement_date'
        db.delete_column(u'data_player', 'retirement_date')

        # Deleting field 'Club.initials'
        db.delete_column(u'data_club', 'initials')


        # Changing field 'Club.short_name'
        db.alter_column(u'data_club', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=3))
