...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'data_match', 'time')

        # Deleting field 'Match.date'
        db.delete_column(u'data_match', 'date')


        # Changing field 'Match.match_datetime'
        db.alter_column(u'data_match', 'match_datetime', self.gf('django.db.models.fields.DateTimeField')(default=None))

    def backwards(self, orm):
        # Adding field 'Match.time'
        db.add_column(u'data_match', 'time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Match.date'
        db.add_column(u'data_match', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Match.match_datetime'
        db.alter_column(u'data_match', 'match_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
