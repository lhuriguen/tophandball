...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlayerContract.from_date'
        db.delete_column(u'data_playercontract', 'from_date')

        # Deleting field 'PlayerContract.to_date'
        db.delete_column(u'data_playercontract', 'to_date')

        # Adding field 'PlayerContract.season'
        db.add_column(u'data_playercontract', 'season',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=24, to=orm['data.Season']),
                      keep_default=False)

        # Adding field 'PlayerContract.departure_month'
        db.add_column(u'data_playercontract', 'departure_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlayerContract.arrival_month'
        db.add_column(u'data_playercontract', 'arrival_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PlayerContract.from_date'
        raise RuntimeError("Cannot reverse this migration. 'PlayerContract.from_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PlayerContract.from_date'
        db.add_column(u'data_playercontract', 'from_date',
                      self.gf('django.db.models.fields.DateField')(),
                      keep_default=False)

        # Adding field 'PlayerContract.to_date'
        db.add_column(u'data_playercontract', 'to_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PlayerContract.season'
        db.delete_column(u'data_playercontract', 'season_id')

        # Deleting field 'PlayerContract.departure_month'
        db.delete_column(u'data_playercontract', 'departure_month')

        # Deleting field 'PlayerContract.arrival_month'
        db.delete_column(u'data_playercontract', 'arrival_month')
    ...
    models = {
        ...
        u'data.grouptable': {
            'Meta': {'unique_together': "(('group', 'team'),)", 'object_name': 'GroupTable'},
