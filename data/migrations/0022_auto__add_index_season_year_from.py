...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Season', fields ['year_from']
        db.create_index(u'data_season', ['year_from'])


    def backwards(self, orm):
        # Removing index on 'Season', fields ['year_from']
        db.delete_index(u'data_season', ['year_from'])
