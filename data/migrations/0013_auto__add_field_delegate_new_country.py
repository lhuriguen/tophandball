...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Delegate.new_country'
        db.add_column(u'data_delegate', 'new_country',
                      self.gf('django_countries.fields.CountryField')(default=' ', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Delegate.new_country'
        db.delete_column(u'data_delegate', 'new_country')
    ...
    models = {
        ...
        u'data.delegate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'new_country': ('django_countries.fields.CountryField', [], {'max_length': '2'})
        },
        u'data.group': {
            'Meta': {'object_name': 'Group'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
