...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Match.stage'
        db.delete_column(u'data_match', 'stage_id')


    def backwards(self, orm):
        # Adding field 'Match.stage'
        db.add_column(u'data_match', 'stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['data.Stage']),
                      keep_default=False)
