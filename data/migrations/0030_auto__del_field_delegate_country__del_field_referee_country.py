...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'data_delegate', 'country')

        # Deleting field 'Referee.country'
        db.delete_column(u'data_referee', 'country')


    def backwards(self, orm):
        # Adding field 'Delegate.country'
        db.add_column(u'data_delegate', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)

        # Adding field 'Referee.country'
        db.add_column(u'data_referee', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)
