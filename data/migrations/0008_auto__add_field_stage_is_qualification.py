...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stage.is_qualification'
        db.add_column(u'data_stage', 'is_qualification',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stage.is_qualification'
        db.delete_column(u'data_stage', 'is_qualification')
