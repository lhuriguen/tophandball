...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerContract.photo'
        db.add_column(u'data_playercontract', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerContract.photo'
        db.delete_column(u'data_playercontract', 'photo')
