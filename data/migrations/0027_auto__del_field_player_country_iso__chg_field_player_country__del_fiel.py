...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'data_player', 'country')
        db.delete_column(u'data_coach', 'country')

        # Rename field 'Player.country_iso'
        db.rename_column(u'data_player', 'country_iso', 'country')
        db.rename_column(u'data_coach', 'country_iso', 'country')

    def backwards(self, orm):

        # Rename field 'Player.country'
        db.rename_column(u'data_player', 'country', 'country_iso')
        db.rename_column(u'data_coach', 'country', 'country_iso')

        # Adding field 'Player.country'
        db.add_column(u'data_player', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)

        # Adding field 'Coach.country'
        db.add_column(u'data_coach', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)


        # Changing field 'Coach.country'
        db.alter_column(u'data_coach', 'country', self.gf('django.db.models.fields.CharField')(max_length=3))
