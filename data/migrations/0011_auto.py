...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field fans on 'Club'
        m2m_table_name = db.shorten_name(u'data_club_fans')
    ...
    def backwards(self, orm):
        # Removing M2M table for field fans on 'Club'
        db.delete_table(db.shorten_name(u'data_club_fans'))
    ...
    models = {
        ...
        u'data.club': {
            ...
            'fans': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'fan_clubs'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
