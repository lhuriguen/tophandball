...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.match_datetime'
        db.add_column(u'data_match', 'match_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.match_datetime'
        db.delete_column(u'data_match', 'match_datetime')
    ...
    models = {
        ...
        u'data.match': {
            ...
            'match_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
