...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.birth_date'
        db.alter_column(u'data_player', 'birth_date', self.gf('django.db.models.fields.DateField')(null=True))
        # Deleting field 'CoachContract.from_date'
        db.delete_column(u'data_coachcontract', 'from_date')

        # Deleting field 'CoachContract.to_date'
        db.delete_column(u'data_coachcontract', 'to_date')

        # Adding field 'CoachContract.season'
        db.add_column(u'data_coachcontract', 'season',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=24, to=orm['data.Season']),
                      keep_default=False)

        # Adding field 'CoachContract.departure_month'
        db.add_column(u'data_coachcontract', 'departure_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CoachContract.arrival_month'
        db.add_column(u'data_coachcontract', 'arrival_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Player.birth_date'
        db.alter_column(u'data_player', 'birth_date', self.gf('django.db.models.fields.DateField')(default=None))
        # Adding field 'CoachContract.from_date'
        db.add_column(u'data_coachcontract', 'from_date',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Adding field 'CoachContract.to_date'
        db.add_column(u'data_coachcontract', 'to_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CoachContract.season'
        db.delete_column(u'data_coachcontract', 'season_id')

        # Deleting field 'CoachContract.departure_month'
        db.delete_column(u'data_coachcontract', 'departure_month')

        # Deleting field 'CoachContract.arrival_month'
        db.delete_column(u'data_coachcontract', 'arrival_month')
